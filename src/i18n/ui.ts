...
export const texts = {
  es: {
    ...
    firstText:
      '<p>Muchas veces nos enfocamos en ganar más dinero, pero es igual o más importante <b> perder menos</b>.</p><p>Y sin hablar de dinero,<br/><span class="g-color">¿Que pasa si Hacienda llama a tu puerta por no hacer las cosas bien?</span></p><p>Una contabilidad básica, te entrega números a final de año, y nada más, una contabilidad bien gestionada es una herramienta para optimizar lo que ganas para perder menos, especialmente en un país donde los laberintos administrativos y burocráticos son cada vez más complicados.</p><br/><p>A ver, <span class="g-color">si estabas enfocando bien el problema</span>, tus energías deben estar en ganar más, pero solamente cuando la parte contable y fiscal está en buenas manos.</p><p>Si esto resuena contigo, ya hay personas que tienen sus cuentas optimizadas.<br/> <b>Sigue leyendo.</b></p>',
